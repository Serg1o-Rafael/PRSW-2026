...
/* A função insertAdjacentText é utilizada para inserir texto em uma posição referente a um elemento (tag HTML) */

/* O parâmetro "beforeend" se refere a posição que é dentro da tag, mas no final dela.*/

function atualizaTexto() {

let largura_janela = window.innerWidth // Largura em Pixel da janela do navegador.
...
if(largura_janela <= 480) {
    ...
    paragrafo.insertAdjacentText("beforeend", "Esta frase é monitor de alta resolução ou seja FullHD");
}
